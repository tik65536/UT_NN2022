...
class Vgg16VAE(nn.Module):
    ...
    def __init__(self,pool=None,device=None):
        ...
        self.FCM = torch.nn.Linear(64*8*8,256).to(self.device)
        self.FCV = torch.nn.Linear(64*8*8,256).to(self.device)
        ...
        self.decoder = nn.Sequential(
                        ...
                        nn.Conv2d(4,64,kernel_size=3,stride=1,padding=1),  #decode 1
