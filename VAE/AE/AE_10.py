...
class AE(torch.nn.Module):
    def __init__(self,ek_size=3,dk_size=3,channel=3,pool='avg',device=None):
        ...
        self.FCM = torch.nn.Linear(512*3*3,10).to(self.device)
        self.encoder=None
        ...
        self.decoder =  torch.nn.Sequential(
            torch.nn.ConvTranspose2d(1,64,(2,2),stride=1),        #   (64,6,6) 6
            torch.nn.ReLU(), #(6,5)
            torch.nn.ConvTranspose2d(64,512,(3,2),stride=(2,1)),        #   (512,13,13) 14
            torch.nn.ReLU(),
            torch.nn.ConvTranspose2d(512,256,3,stride=2),        #   (256,27,27) 30
            torch.nn.ReLU(),
